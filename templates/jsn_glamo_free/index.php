...
<body id="jsn-master" class="<?php echo $this->bodyClass ?>">
	...
	?>
		...
		<div id="jsn-body">
		<?php
			/*====== Show modules in position "promo-over" ======*/
			if ($jsnutils->countModules('promo-over') > 0) {
		?>
				<div id="jsn-promo-over">
					<jdoc:include type="modules" name="promo-over" style="jsnmodule"/>
				</div>
		<?php
			}
		...
		?>
			<div id="jsn-content-top-below">
				<div id="jsn-content-top-below_inner" class="clearafter">
		...
		?>
							<div id="jsn-mainbody-content" class="<?php echo ($jsnutils->countModules('mainbody-top') > 0)?' jsn-hasmainbodytop':'' ?><?php echo ($jsnutils->countModules('mainbody-bottom') > 0)?' jsn-hasmainbodybottom':'' ?><?php echo ($this->showFrontpage)?' jsn-hasmainbody':'' ?> <?php echo (($this->hasInnerLeft)?'jsn-hasinnerleft ':'') ?><?php echo (($this->hasInnerRight)?'jsn-hasinnerright ':'') ?>">
		...
		?>
			...
			?>
			<div id="jsn-usermodules3" class="jsn-modulescontainer jsn-modulescontainer<?php echo $this->helper->countPositions('user5', 'user6', 'user7'); ?>">
			...
			<div id="jsn-content-bottom-over">
					<div id="jsn-content-bottom-over_inner">
						...
						<div id="jsn-pos-content-bottom" class="jsn-modulescontainer jsn-horizontallayout jsn-modulescontainer<?php echo $jsnutils->countModules('content-bottom-over'); ?> row-fluid">
		...
		<div id="jsn-footer">
			...
			<div id="jsn-brand">
				JSN Glamo template designed by <a href="http://www.joomlashine.com" target="_blank" title="Free Hi-Quality Joomla Templates on JoomlaShine">JoomlaShine.com</a>
			</div>
		</div>
		<?php
			}

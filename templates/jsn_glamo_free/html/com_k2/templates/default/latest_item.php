...
<div class="latestItemView span<?php echo round(12 / $this->params->get('latestItemsCols'));?>"> 
	...
	<div class="latestItemBody"> 
		...
		<div class="latestItemImageBlock">
			<span class="latestItemImage"> <a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>"> <img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:<?php echo $this->item->imageWidth; ?>px;height:auto;" /> </a> </span>
			<?php if($this->item->params->get('latestItemDateCreated')): ?>
			<!-- Date created -->
				<div class="createdate"><span class="createdate-day"><?php echo JHTML::_('date', $this->item->created , JText::_('d')); ?></span><span class="createdate-month"><?php echo JHTML::_('date', $this->item->created , JText::_('M')); ?></span><span class="createdate-year"><?php echo JHTML::_('date', $this->item->created , JText::_('Y')); ?></span></div>
			<?php endif; ?>
			<div class="clr"></div>
		</div>
		<?php endif; ?>
		...
		<div class="jsn-article-toolbar">
			<div class="jsn-article-info">
				...
				<!-- Item category name -->
				<div class="latestItemCategory"> <span><?php echo JText::_('K2_PUBLISHED_IN'); ?></span>: <a href="<?php echo $this->item->category->link; ?>"><?php echo $this->item->category->name; ?></a>
				</div>
				<?php endif; ?>
			</div>
		</div>

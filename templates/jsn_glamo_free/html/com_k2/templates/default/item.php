...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>"> 
	...
	<div class="itemHeader">
		...
		<div class="jsn-article-toolbar">
			...
			<div class="jsn-article-info pull-left">
				...
				<!-- Item category -->
				<div class="itemCategory"> <span><?php echo JText::_('K2_PUBLISHED_IN'); ?>:</span> <a href="<?php echo $this->item->category->link; ?>"><?php echo $this->item->category->name; ?></a>
				</div>
				<?php endif; ?>
	...
	<div class="itemBody"> 
		...
		<div class="itemImageBlock"> <span class="itemImage"> <a class="modal" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>"> <img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;" /> </a> </span>
			...
			<!-- Item Created Date -->
			<div class="jsn-createdate"><span class="createdate-day"><?php echo JHTML::_('date', $this->item->created , JText::_('d')); ?></span><span class="createdate-month"><?php echo JHTML::_('date', $this->item->created , JText::_('M')); ?></span><span class="createdate-year"><?php echo JHTML::_('date', $this->item->created , JText::_('Y')); ?></span></div>
			<?php endif; ?>
			<div class="clr"></div>
		</div>
		<?php endif; ?>
	...
	<div class="itemComments">
		...
		<ul class="itemCommentsList">
			...
			<li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
				...
				<div class="itemCommentsWrapper" style="margin-left: <?php echo $this->item->params->get('commenterImgWidth'); ?>px;">
					<p>
						<span class="commentDate createdate"> <?php echo JHTML::_('date', $comment->commentDate, JText::_('K2_DATE_FORMAT_LC2')); ?></span>
						<span class="commentAuthorName author"> <?php echo JText::_('K2_POSTED_BY'); ?>:
		...
		<div class="itemLoginComments"><?php echo JText::_('K2_LOGIN_TO_POST_COMMENTS'); ?></div>
		<?php endif; ?>
	</div>
	<?php endif; ?>

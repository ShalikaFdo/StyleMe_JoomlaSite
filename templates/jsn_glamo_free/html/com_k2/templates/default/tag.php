				...
				<div class="tagItemHeader">
					...
					<div class="jsn-article-toolbar">
						<div class="jsn-article-info">
							...
							<div class="createdate"><span class="createdate-day"><?php echo JHTML::_('date', $item->created , JText::_('d')); ?></span><span class="createdate-month"><?php echo JHTML::_('date', $item->created , JText::_('M')); ?></span><span class="createdate-year"><?php echo JHTML::_('date', $item->created , JText::_('Y')); ?></span></div>
							<?php endif; ?>
							<?php if($item->params->get('tagItemCategory')): ?>
							<!-- Item category name -->
							<div class="tagItemCategory"><span><?php echo JText::_('K2_PUBLISHED_IN'); ?>:</span> <a href="<?php echo $item->category->link; ?>"><?php echo $item->category->name; ?></a>
							</div>
							<?php endif; ?>
						</div>
					</div>
